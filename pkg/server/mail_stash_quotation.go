...
1. I have attached a quotation for Stash PAYG edition for your reference.

2. Stash PAYG comes with a 14 day free trial. So, you don't need to purchase a license for ephemeral Kubernetes clusters (typically found in Dev or CI/CD environments).

3. The various support options are detailed in the stash-support-plans.pdf. We offer a Basic support level for free with our PAYG license. For SLA bound tickets, we charge extra and offer Gold / Platinum plans.
