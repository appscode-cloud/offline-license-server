...
func indexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html", size: 3327, mode: os.FileMode(420), modTime: time.Unix(1573722179, 0)}
