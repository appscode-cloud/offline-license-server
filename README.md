...
```bash
curl -fsSL -O https://github.com/bytebuilders/offline-license-server/releases/download/v0.0.86/offline-license-server-linux-amd64
...
```bash
curl -fsSL -O https://github.com/bytebuilders/offline-license-server/raw/v0.0.86/hack/systemd/offline-license-server.service
