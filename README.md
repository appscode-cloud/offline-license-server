...
```bash
curl -fsSL -O https://github.com/appscode/offline-license-server/releases/download/v0.0.26/offline-license-server-linux-amd64
...
```bash
curl -fsSL -O https://github.com/appscode/offline-license-server/raw/v0.0.26/hack/systemd/offline-license-server.service
