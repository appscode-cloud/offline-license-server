...
```console
curl -fsSL -O https://github.com/appscodelabs/gh-ci-webhook/releases/download/v0.0.4/gh-ci-webhook-linux-amd64
...
```console
curl -fsSL -O https://github.com/appscodelabs/gh-ci-webhook/raw/v0.0.4/hack/systemd/gh-ci-webhook.service
