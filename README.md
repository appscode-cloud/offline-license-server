...
```bash
curl -fsSL -O https://github.com/appscode/offline-license-server/releases/download/v0.0.18/offline-license-server-linux-amd64
...
```bash
curl -fsSL -O https://github.com/appscode/offline-license-server/raw/v0.0.18/hack/systemd/offline-license-server.service
...
#    - set MG_API_KEY
#    - set APPSCODE_PRICING_USERNAME
#    - set APPSCODE_PRICING_PASSWORD
#    - add `--ssl`
