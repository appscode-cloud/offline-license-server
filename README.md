...
```console
curl -fsSL -O https://github.com/appscode/offline-license-server/releases/download/v0.0.5/offline-license-server-linux-amd64
...
```console
curl -fsSL -O https://github.com/appscode/offline-license-server/raw/v0.0.5/hack/systemd/offline-license-server.service
